...
var ASM_CONSTS = {
  7614008: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 7614063: ($0) => { performance.now = function() { return $0; }; },  
 7614111: ($0) => { performance.now = function() { return $0; }; },  
 7614159: () => { performance.now = Module['emscripten_get_now_backup']; }
};
